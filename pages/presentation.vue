...
<template>
  <div class="container mx-auto p-4">
    <div class="mb-8 text-center">
      <h1 class="mb-2 text-3xl font-bold uppercase">Qui sommes-nous?</h1>
    </div>
    <div>
      <figure class="rounded-xl bg-slate-100 p-8 md:flex md:p-0">
        <NuxtImg
          class="mx-auto h-24 w-24 rounded-full object-cover md:h-auto md:w-48 md:rounded-none"
          src="/img/jesse.jpeg"
          alt="jesse salomas"
        />
        <div class="mx-auto space-y-4 pt-6 text-center md:p-8 md:text-left">
          <figcaption class="justify-self-start font-medium">
