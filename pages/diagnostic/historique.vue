  ...
  <div class="container mx-auto p-4">
    <div class="mb-8 text-center">
      <h1 class="mb-2 text-3xl font-bold">
        Historique du diagnostic : l'essentiel
      </h1>
      <p class="text-gray-600">
        Chronologie des principaux diagnostics immobiliers depuis 1996
      </p>
    </div>
    ...
    <div class="mb-8">
      ...
      <ul class="list-inside list-disc pl-8 leading-relaxed text-gray-700">
        <li>
          Superficie de loi Carrez + repérage des calorifugeage et flocages (en
          amiante)
        </li>
      </ul>
    </div>
    ...
    <div class="mb-8">
      ...
      <p class="leading-relaxed text-gray-700">
        ...
        constante, ils nécessitent du diagnostiqueur immobilier un important
        travail de mise à jour de ses connaissances théoriques et pratiques. Une
        formation initiale ne suffit donc pas. La nécessité de disposer d'une
        certification pour les différents diagnostics immobiliers impose une
        capacité d'adaptation aux exigences techniques et législatives
        nouvelles. Le métier de diagnostiqueur est donc soumis à des évolutions,
        au fil de la loi et de l'apparition de nouveaux diagnostics.
      </p>
    </div>
  </div>
</template>
