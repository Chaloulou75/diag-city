<template>
  <div class="container mx-auto p-4">
    <div class="mb-8 text-center">
      <h1 class="mb-2 text-3xl font-bold uppercase">Le D.T.G.</h1>
      <p class="text-gray-600">
        Utilité, obligations, déroulement et validité du Diagnostic Technique
        Global (DTG) pour les copropriétés
      </p>
    </div>
    ...
    <div class="mb-8">
      ...
      <p class="leading-relaxed text-gray-700">
        ...
        instaure la réalisation d’un Diagnostic Technique Global (DTG) pour les
        copropriétés. L’objectif de cette nouvelle disposition est d’assurer
        l'information des copropriétaires sur la situation générale de leur
        immeuble en réalisant un état des lieux technique et réglementaire du
        bâtiment.
      </p>
    </div>
    ...
    <div class="mb-8">
      ...
      <ul class="list-inside list-disc pl-8 leading-relaxed text-gray-700">
        ...
        <li>
          Ou qui font l'objet d'une insalubrité et pour lesquelles
          l'administration demande au syndic de le lui produire.
        </li>
      </ul>
      <p class="leading-relaxed text-gray-700">
        La loi prévoit malgré tout l'obligation pour toutes les copropriétés de
        mettre au vote de l'assemblée générale la réalisation d'un DTG, sans
        obligation de le voter.
      </p>
    </div>
    ...
    <div class="mb-8">
      ...
      <ul class="list-inside list-disc pl-8 leading-relaxed text-gray-700">
        ...
        <ul class="list-inside list-disc pl-8 leading-relaxed text-gray-700">
          ...
          <li>
            Un état de la situation du syndicat des copropriétaire au regard des
            obligations légales et règlementaires au titre de la construction et
            de l’habitation (fiche synthétique de la copropriété…)
          </li>
        </ul>
        <li>
        ...
        <ul class="list-inside list-disc pl-8 leading-relaxed text-gray-700">
          <li>
            L’accès à l’ensemble des parties et espaces communs (codes, badges,
            clés…)
          </li>
          <li>
            Tous documents recensant les travaux effectués dans la copropriété
          </li>
